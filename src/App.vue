...
<template>
  <div>
    <div>
        ...
        >
          <div class="flex items-center">
            <img 
              class="rounded-full"
              width="27"
              src="https://yt3.ggpht.com/UwNSKVt4am4hyuTHuQzPW8_wbrpc2ECZTJpFuK4lcGe7dBfHlTkxqjeV9IklyBNyOvs9zXTcKO8=s88-c-k-c0x00ffffff-no-rj" 
            >
            <div class="text-white text-[14px] ml-1.5 font-semibold">Phan Phong</div>
            <ChevronDown v-if="!openMenu" @click="openMenu = false" fillColor="#FFFFFF" :size="25" />
            <ChevronUp v-else @click="openMenu = true" fillColor="#FFFFFF" :size="25" />
          </div>
        </button>
      ...
      >
        <RouterLink to="/">
          <img src="/images/icons/spotify-logo.png" width="125">
        </RouterLink>
        <div class="my-8"></div>
        <ul>
          <RouterLink to="/">
          ...
          <MenuItem class="-ml-[1px]" :iconSize="24" name="Liked Songs" iconString="liked" pageUrl="/liked" />
          <ul>
